/*
 * IDENTIFICATION:
 * stub generated Tue Jul  8 19:43:50 2014
...
mig_internal kern_return_t __MIG_check__Reply__memory_object_map_t(__Reply__memory_object_map_t *Out0P)
{
	...
	typedef __Reply__memory_object_map_t __Reply;
...
mig_internal kern_return_t __MIG_check__Reply__memory_object_last_unmap_t(__Reply__memory_object_last_unmap_t *Out0P)
{
	...
	typedef __Reply__memory_object_last_unmap_t __Reply;
...
mig_internal kern_return_t __MIG_check__Reply__memory_object_data_reclaim_t(__Reply__memory_object_data_reclaim_t *Out0P)
{
	...
	typedef __Reply__memory_object_data_reclaim_t __Reply;
