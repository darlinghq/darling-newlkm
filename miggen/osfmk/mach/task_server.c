...
#pragma pack()
	...
	OutP->Head.msgh_size = (mach_msg_size_t)(sizeof(Reply) - 128) + (((4 * OutP->task_info_outCnt)));
...
#if	__MigTypeCheck
	if ( In0P->task_info_inCnt > 32 )
		return MIG_BAD_ARGUMENTS;
	if (((msgh_size - (mach_msg_size_t)(sizeof(__Request) - 128)) / 4 < In0P->task_info_inCnt) ||
	    (msgh_size != (mach_msg_size_t)(sizeof(__Request) - 128) + (4 * In0P->task_info_inCnt)))
		return MIG_BAD_ARGUMENTS;
#endif	/* __MigTypeCheck */
...
#if	__MigTypeCheck
	if ( In0P->new_stateCnt > 144 )
		return MIG_BAD_ARGUMENTS;
	if (((msgh_size - (mach_msg_size_t)(sizeof(__Request) - 576)) / 4 < In0P->new_stateCnt) ||
	    (msgh_size != (mach_msg_size_t)(sizeof(__Request) - 576) + (4 * In0P->new_stateCnt)))
		return MIG_BAD_ARGUMENTS;
#endif	/* __MigTypeCheck */
	...
	(mach_msg_header_t *InHeadP, mach_msg_header_t *OutHeadP)
{
	...
	if ((InHeadP->msgh_id > 3434) || (InHeadP->msgh_id < 3400) ||
