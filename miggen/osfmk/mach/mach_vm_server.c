...
const struct mach_vm_subsystem mach_vm_subsystem = {
	...
	(vm_address_t)0,
	{
          ...
          { (mig_impl_routine_t) 0,
          (mig_stub_routine_t) _Xmach_vm_purgable_control, 4, 0, (routine_arg_descriptor_t)0, (mach_msg_size_t)sizeof(__Reply__mach_vm_purgable_control_t)},
          { (mig_impl_routine_t) 0,
          (mig_stub_routine_t) _Xmach_vm_page_info, 5, 0, (routine_arg_descriptor_t)0, (mach_msg_size_t)sizeof(__Reply__mach_vm_page_info_t)},
	}
};
