 ...
 * created from /home/lubos/morningtec/parlando-linux/wcbuild/../kernel-msm/xnu/bsd/kern/syscalls.master
 */
...
#if CONFIG_KERNEL_0DAY_SYSCALL_HANDLER
struct nosys_args {
	char r0_l_[PADL_(int)]; int r0; char r0_r_[PADR_(int)];
	char r1_l_[PADL_(int)]; int r1; char r1_r_[PADR_(int)];
	char r2_l_[PADL_(int)]; int r2; char r2_r_[PADR_(int)];
	char r3_l_[PADL_(int)]; int r3; char r3_r_[PADR_(int)];
	char r4_l_[PADL_(int)]; int r4; char r4_r_[PADR_(int)];
};
#else
struct nosys_args {
	int32_t dummy;
